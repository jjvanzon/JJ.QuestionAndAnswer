...
namespace JJ.Data.QuestionAndAnswer.Sql
{
	public class QuestionAndAnswerSqlExecutor
	{
	    ...
	    public IEnumerable<int> Question_GetPageOfIDs(int firstRowNumberOneBased, int count)
			=> _sqlExecutor.ExecuteReader<int>(SqlEnum.Question_GetPageOfIDs, new { firstRowNumberOneBased, count });
