...
{
    public class W3CSpecCss21_LooseDefinition_Selector : ISelector<W3CSpecCss21_LooseDefinition_ImportModel>
    {
        ...
        public IEnumerable<W3CSpecCss21_LooseDefinition_ImportModel> GetSelection(Stream stream)
        {
            ...
            {
                W3CSpecCss21_LooseDefinition_ImportModel model = CreateDefinitionModel(record);
                yield return model;
            }
        }
        ...
        private W3CSpecCss21_LooseDefinition_ImportModel CreateDefinitionModel(Record record)
        {
            return new W3CSpecCss21_LooseDefinition_ImportModel
            {
